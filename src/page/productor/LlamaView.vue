<template>
        ...
        <v-col md="12">
          <v-card class="card-shadow border-radius-xl">
            <div class="px-4 pt-5 d-flex justify-space-between">
                ...
                <LlamaForm :updating="true" ref="roleForm" :form="form" @submit="handleFormSubmit"/>
            </div>
                ...
                >
                  ...
                  <v-list-item-content class="py-0 text-end">
                    <div class="d-flex align-center text-sm text-body">
                      ...
                      <LlamaForm :updating="false" ref="roleForm"/>
                    </div>
                  </v-list-item-content>
                </v-list-item>
              </div>
  ...
  import LlamaForm from '@/component/llama/form.vue';
  export default {
    name: "Llamas",
    components: {
      LlamaForm
